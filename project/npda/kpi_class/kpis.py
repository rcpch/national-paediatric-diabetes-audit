...
class CalculateKPIS:
    ...
    def get_median_hba1c_values_by_patient(
        ...
        for visit in valid_visits:
            hba1c_values_by_patient[visit["patient__pk"]]["hb1ac_values_mmol_mol"].append(
                visit["hba1c_mmol_mol"]
            )
            hba1c_values_by_patient[visit["patient__pk"]]["hb1ac_values_percent"].append(
                visit["hba1c_percent"]
            )
        ...
        for patient_id, values in hba1c_values_by_patient.items():
            hba1c_values_by_patient[patient_id]["median_mmol_mol"] = self.calculate_median(
                values["hb1ac_values_mmol_mol"]
            )
            hba1c_values_by_patient[patient_id]["median_percent"] = self.calculate_median(
                values["hb1ac_values_percent"]
            )
