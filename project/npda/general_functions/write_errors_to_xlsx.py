...
def write_errors_to_xlsx(
    errors: dict[str, dict[str, list[str]]], original_csv_file_bytes: bytes, dataset_year: int = 2021
) -> bytes:
    """
    ...
    # Get original data
    parsed_csv = csv_parse(io.BytesIO(initial_bytes=original_csv_file_bytes), dataset_year=dataset_year)
