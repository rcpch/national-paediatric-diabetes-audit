...
def seed_users_per_function_fixture(django_db_setup, django_db_blocker, test_pz_codes_function_fixture):
    _seed_users_fixture(django_db_setup, django_db_blocker, test_pz_codes_function_fixture)