# Generated by Django 5.0 on 2023-12-23 22:50

import django.contrib.gis.db.models.fields
import django.db.models.deletion
import django.db.models.functions.text
import django.utils.timezone
import project.npda.models_folder.help_text_mixin
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(verbose_name="GP Practice Code"),
                ),
            ],
            options={
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="npda_countr_boundar_e80991_idx",
                    )
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["ods_code"], name="npda_localh_ods_cod_6d8881_idx"
                    )
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["gss_code"], name="npda_london_gss_cod_940565_idx"
                    )
                ],
            },
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DateField(verbose_name="Date of leaving service"),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["ods_code"], name="npda_trust_ods_cod_25a4ee_idx"
                    )
                ],
            },
        ),
        ...
        migrations.CreateModel(
            ...
            bases=(
                models.Model,
                project.npda.models_folder.help_text_mixin.HelpTextMixin,
            ),
        ),
        ...
        migrations.AddIndex(
            model_name="organisation",
            index=models.Index(fields=["name"], name="npda_organi_name_5f93a9_idx"),
        ),
    ]
