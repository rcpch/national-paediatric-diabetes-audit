...
SECRET_KEY = os.getenv("NPDA_DJANGO_SECRET")
...
RCPCH_DEPRIVATION_TILES_URL = os.getenv("RCPCH_DEPRIVATION_TILES_URL")
...
database_config = {
    ...
    "ENGINE": "project.npda.db_backend",
...
if os.environ.get("NPDA_POSTGRES_DB_USE_AAD_TOKEN", "False") == "True":
