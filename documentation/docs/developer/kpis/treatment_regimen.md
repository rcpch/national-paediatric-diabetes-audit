...
**Numerator**: Number of eligible patients whose most recent entry (based on visit date) for treatment regimen (item 20) is 3 = Insulin pump or 6 = Insulin pump plus other glucose lowering medication
